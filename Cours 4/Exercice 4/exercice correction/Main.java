...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Quelle factorielle est désirée ?");
        // final = une fois que quelque chose est mis dans cette case mémoire là il ne peut pas changer.
        // final est la const de JAVA
        final int factorielle = readNextInt();
        
        // Long est accepté car on monte en précision
        // resultat = index // Impossible car on perd en précision
        // index = resultat // Possible car on monte en précision
        long resultat = 1;
        int index = 0;
        
        while (index < factorielle) {
        index++;
        resultat *= index;
        }
