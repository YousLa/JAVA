...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Ecrire un programme qui prends un nombre entier en entrée en affichent 
        // si celui-ci est premier.
        // Rappel : un nombre est premier si il n'est divisible que par lui-même et 1.
