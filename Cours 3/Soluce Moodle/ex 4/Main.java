...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Quel est le prix en cents ?");
        int prix = readNextInt();
        
        int cents = prix % 100; // ici on extrait le nombre de cents
        ...
        System.out.println("Le prix est de :" + (prix / 100));
