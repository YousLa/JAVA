...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 1. Demander à l'utilisateur d'enter un nombre
        System.out.println("Veuillez introduire un nombre");
        
        // 2. Créer la variable qui va accueillir ce nombre
        
        double nombre = readNextDouble();
        
        // 3. Passer le nombre dans l'équation
        
        double resultat = 3.0 * nombre * nombre * nombre  + (2.0 - nombre)/ 2.0 * 3.0 + -1.0 * nombre * nombre + 42.0; 
        
        // 4. Afficher le résultat
        
        System.out.println("Le résultat de l'équation est : " + resultat);
